...
import AboutImg from "../assets/IMG_3287.jpg";
const About = () => {
  return (
    <section>
          ...
          <div className="col-lg-6">
            <div className={classes.AboutContent}>
              ...
              <p>
                ...
                seasoned Master of Ceremonies, Compere, Presenter, and Public
                Speaker.
              </p>

              <p>
                Armed with both Bachelor's and Master's degrees in Sociology
                from the University of Lagos, his professional journey blends
                intellect with entertainment.
              </p>
              ...
              <p>
                MC Celebrity officially launched his emceeing career in 2016,
                but his journey on the mic began in 2010. Since then, he’s
                graced numerous stages—from corporate AGMs and seminars to
                weddings, faith-based events, and kiddies parties.
              </p>

              <p>
                With a commanding mic presence, articulate delivery, and an
                unmatched stage energy, he continues to bring life to events and
                smiles to audiences.
              </p>
